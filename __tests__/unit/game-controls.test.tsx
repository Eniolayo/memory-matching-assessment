...
describe("GameControls Component", () => {
  ...
  it("renders clicks counter correctly", () => {
    render(
      <GameControls clicks={42} bestScore={null} onRestart={mockOnRestart} />
    );
  ...
  it("does not render best score when null", () => {
    render(
      <GameControls clicks={10} bestScore={null} onRestart={mockOnRestart} />
    );
  ...
  it("renders best score when available", () => {
    render(
      <GameControls clicks={10} bestScore={8} onRestart={mockOnRestart} />
    );
